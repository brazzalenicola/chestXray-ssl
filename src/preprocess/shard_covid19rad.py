...
def write_covid19rad_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/COVID-19_Radiography_Dataset"
    ...
    write_covid19rad_shards(
        "/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/COVID-19_Radiography_Dataset/covid19rad-data-%06d.tar", 
        maxsize=10e9)
