...
def write_covidgr_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/COVIDGR"
    ...
    write_covidgr_shards(
        "/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/COVIDGR/covidgr-data-%06d.tar", 
        maxsize=10e9)
