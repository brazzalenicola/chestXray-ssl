...
def write_china_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/ChinaSet"
    ...
    write_china_shards(
        "/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/ChinaSet/chinaset-data-%06d.tar", 
