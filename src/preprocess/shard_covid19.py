...
def write_covid19_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/COVID-19Dataset"
    ...
    write_covid19_shards("/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/COVID-19Dataset/covid19-data-%06d.tar", 
