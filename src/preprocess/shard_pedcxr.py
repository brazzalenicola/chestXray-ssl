...
def write_pedcxr_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/PedCXR"
    ...
    write_pedcxr_shards(
        "/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/PedCXR/pedcxr-data-%06d.tar", 
