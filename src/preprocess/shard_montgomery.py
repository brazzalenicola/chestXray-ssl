...
def write_montgomery_shards(out_pattern, indexes, image_paths, classes, maxsize=(10e9)):
...
if __name__ == "__main__":
    ...
    path = "/Volumes/TOSHIBA EXT/DATASETS/MontgomerySet"
    ...
    write_montgomery_shards(
        "/Volumes/TOSHIBA EXT/DATASETS/sharded_datasets/MontgomerySet/montgomery-data-%06d.tar", 
