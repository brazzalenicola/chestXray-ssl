...
class VisionTransformer(pl.LightningModule):
    def __init__(self, num_classes,  lr, weight_decay, pretrained_model = None):
        ...
        self.encoder = timm.create_model('vit_large_patch32_384', pretrained=True, num_classes=num_classes)
    ...
    def val_epoch_end(self, step_otputs, mode):
        ...
        print("ROC-AUC score:", metrics.roc_auc_score(y_trues,y_preds, average=None))
        print()
